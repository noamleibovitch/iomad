...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        $messagesmsmessages = [
            'useridto' => 'privacy:metadata:message_sms_messages:useridto',
            'conversationid' => 'privacy:metadata:message_sms_messages:conversationid',
            'messageid' => 'privacy:metadata:message_sms_messages:messageid',
        ];
        // Note - this data gets deleted once the scheduled task runs.
        $collection->add_database_table('message_sms_messages',
            $messagesmsmessages, 'privacy:metadata:message_sms_messages');
