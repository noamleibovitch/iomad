 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sms_digest implements \renderable, \templatable {
    ...
    /**
     * @var \stdClass The user we want to send the digest sms to
     */
    protected $userto;

    /**
     * The sms_digest constructor.
     *
     ...
     *
     * @param \renderer_base $renderer The render to be used for formatting the sms
    ...
    public function export_for_template(\renderer_base $renderer) {
        ...
        foreach ($this->conversations as $conversation) {
            ...
            $conversationformatted->viewallmessageslink = \html_writer::link($viewallmessageslink,
                get_string('smsdigestviewallmessages', 'message_sms'));
