...
/**
 * Upgrade code for sms message processor
 *
 * @package    message_sms
...
/**
 * Upgrade code for the sms message processor
 *
 * @param int $oldversion The version that we are upgrading from
 */
function xmldb_message_sms_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2019032500) {
        // Define table message_sms_messages to be created.
        $table = new xmldb_table('message_sms_messages');

        // Adding fields to table message_sms_messages.
        ...
        // Adding keys to table message_sms_messages.
        ...
        // Conditionally launch create table for message_sms_messages.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }

        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2019032500, 'message', 'sms');
    }
