...
class event_observers {
	...
	public static function course_completed($event) {
		...
		\local_mekorot\event_observers::agent_log("User comleted a course event fired");
		...
		\local_mekorot\event_observers::agent_log ("grade is: " . $grade);
	    	\local_mekorot\event_observers::agent_log ('lms User Id: '.$lmsid);
		\local_mekorot\event_observers::agent_log ('lms Course Id: '.$courseid);
		\local_mekorot\event_observers::agent_log ('Employee ID: '.$employeeId);
		\local_mekorot\event_observers::agent_log ('SAP E: '.$E);
		
$postfields = array('employeeId'=>$employeeId, 'sapE'=>$E, 'grade'=>$grade);
$ch = curl_init();
